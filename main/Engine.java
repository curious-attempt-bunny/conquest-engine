...
public class Engine {
	...
	public void distributeStartingRegions()
	{
		...
		ArrayList<Region> p1Regions = null; //parser.parsePreferredStartingRegions(player1.getBot().getPreferredStartingArmies(2000, pickableRegions), pickableRegions, player1);
		ArrayList<Region> p2Regions = null; //parser.parsePreferredStartingRegions(player2.getBot().getPreferredStartingArmies(2000, pickableRegions), pickableRegions, player2);
